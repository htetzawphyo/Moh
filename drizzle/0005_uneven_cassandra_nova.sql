...
INSERT INTO `__new_expense`("expense_id", "budget_id", "category_id", "amount", "expense_date") SELECT "expense_id", "budget_id", "category_id", "amount", "expense_date" FROM `expense`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_today_expense`("today_expense_id", "budget_id", "category_id", "amount", "expense_date") SELECT "today_expense_id", "budget_id", "category_id", "amount", "expense_date" FROM `today_expense`;--> statement-breakpoint
